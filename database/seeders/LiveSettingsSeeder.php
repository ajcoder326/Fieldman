...
class LiveSettingsSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        Settings::create([
            ...
            'is_task_module_enabled' => false,
            'is_notice_module_enabled' => false,
            'is_dynamic_form_module_enabled' => false,
            'is_expense_module_enabled' => true,
            'is_leave_module_enabled' => true,
            'is_document_module_enabled' => false,
            'is_chat_module_enabled' => true,
            'is_loan_module_enabled' => false,
            'is_payment_collection_module_enabled' => false,
            'is_geofence_attendance_module_enabled' => false,
            'is_ip_attendance_module_enabled' => false,
            'is_uid_login_module_enabled' => false,
            'is_client_visit_module_enabled' => true,
            'is_offline_tracking_module_enabled' => false,
            'is_data_import_export_module_enabled' => false,
            'is_site_module_enabled' => false,
            'is_qr_attendance_module_enabled' => false,
            'is_dynamic_qr_attendance_module_enabled' => false,
            'is_break_module_enabled' => false,
